            ...
            >
              ...
              <div className="flex flex-wrap items-center gap-6 justify-between md:justify-end w-full md:w-2/5">
                <div className="flex flex-col text-left md:text-right">
                  <span className="text-[9px] uppercase font-bold text-white/30">Logística</span>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-3">
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="w-full text-center flex items-center justify-center gap-2 py-2.5 bg-yellow-400 hover:bg-yellow-300 text-slate-950 font-extrabold rounded-xl text-xs shadow-md transition-all mt-4"
                      >
                  ...
                  <div className="bg-white/[0.01] border border-white/5 p-4 rounded-2xl space-y-4 select-text">
                    ...
                    <div className="pt-2 flex gap-2">
                      ...
                      <button
                        ...
                        disabled={saving}
                        className="flex-1 bg-yellow-400 hover:bg-yellow-300 disabled:opacity-50 text-slate-950 px-4 py-2.5 rounded-xl font-extrabold text-xs shadow-md transition-all flex items-center justify-center gap-1.5 cursor-pointer"
                      >
